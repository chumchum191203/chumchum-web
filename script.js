...
$(document).ready(function () {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    var minusBtn = document.querySelector(".minus-btn-1");
    var plusBtn = document.querySelector(".plus-btn-1");
    var quantityInput = document.querySelector(".quantity-input-1");
  ...
  function toggleImage(imageNumber) {
    var hinhLon1 = document.getElementById('hinhLon1');
    var hinhLon2 = document.getElementById('hinhLon2');
  
    if (imageNumber === 1) {
      hinhLon1.classList.remove('hidden');
      hinhLon2.classList.add('hidden');
    } else if (imageNumber === 2) {
      hinhLon1.classList.add('hidden');
      hinhLon2.classList.remove('hidden');
    }
  }
